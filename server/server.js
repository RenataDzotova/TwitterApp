...
const currentPostCookieName = "post_id";
...
app.post("/posts", (req, res) => {
  ...
  db.execute("INSERT INTO posts(text, user_name, user_id) VALUES (?, ?, ?)", [
    text,
    users[0].name,
    userId,
  ]);
...
app.post("/report/:userIdToReport", (req, res) => {
  ...
  db.execute("INSERT INTO reports (user_id, report_id) VALUES (?, ?)", [
    userIdToReport,
    currentUserId,
  ]);
...
app.listen(3001, () => {
  console.log("Server is rußnning on 3001");
});
